      ...
      <div className="flex-1 overflow-y-auto p-8 bg-[#F8FAFC]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex items-end justify-between mb-8">
            <div>
              <h1 className="text-[32px] font-bold text-gray-900 tracking-tight">Recepción de Devoluciones</h1>
              <p className="text-neutral-400 font-medium mt-1">Registra los libros que están siendo devueltos a la biblioteca</p>
            </div>
