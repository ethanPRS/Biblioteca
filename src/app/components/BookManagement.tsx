      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 bg-[#F8FAFC]">
        <div className="max-w-[1400px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-6 md:mb-8 gap-4">
            <div>
              <h1 className="text-2xl md:text-[32px] font-bold text-gray-900 tracking-tight">Gestión de Libros</h1>
              <p className="text-sm md:text-base text-neutral-400 font-medium mt-1">Administra el inventario y catálogo de la biblioteca</p>
            </div>
