...
function initializeDatabase() {
  ...
  if (userCount.count === 0) {
    db.exec(`
      ...
      INSERT INTO LIBRO (id_libro, titulo, autor, editorial_clave, edicion, precio, sinopsis, formato, estatus_catalogo, isbn, foto) VALUES
      (1, 'La psicología del dinero', 'Morgan Housel', 'Harriman House', '1ra Edición', 350.00, 'Un análisis fascinante sobre cómo pensamos acerca del dinero y cómo tomar mejores decisiones financieras.', 'Físico', 'Disponible para préstamo a casa', '978-0857197689', 'https://covers.openlibrary.org/b/isbn/9780857197689-L.jpg'),
      (2, 'Company of One', 'Paul Jarvis', 'Penguin Books', '1ra Edición', 280.00, 'Una guía sobre cómo crear un negocio exitoso manteniéndolo pequeño e independiente.', 'Físico', 'Disponible para préstamo a casa', '978-0241380222', 'https://images.unsplash.com/photo-1706885655567-33a37db62835?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhYnN0cmFjdCUyMGdyYXBoaWMlMjBkZXNpZ24lMjBwb3N0ZXJ8ZW58MXx8fHwxNzcyNjI1OTE5fDA&ixlib=rb-4.1.0&q=80&w=400'),
      (3, 'El gran Gatsby', 'F. Scott Fitzgerald', 'Scribner', '2da Edición', 220.00, 'Una obra maestra de la literatura americana sobre el sueño americano y la decadencia moral.', 'Físico', 'Disponible para uso interno', '978-0743273565', 'https://images.unsplash.com/photo-1770581939371-326fc1537f10?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0eXBvZ3JhcGh5JTIwcG9zdGVyJTIwZGVzaWdufGVufDF8fHx8MTc3MjczNDQzMnww&ixlib=rb-4.1.0&q=80&w=400'),
      ...
      INSERT INTO LIBRO (titulo, autor, editorial_clave, edicion, precio, sinopsis, formato, estatus_catalogo, isbn, foto) VALUES 
      ('El Alquimista', 'Paulo Coelho', 'GRIJALBO', '1a edición', 299.00, 'La historia de Santiago, un pastor andaluz que emprende un viaje en busca de un tesoro y descubre que la mayor riqueza está en seguir los sueños del alma.', 'Físico', 'Activo', '9786073809603', 'https://images.unsplash.com/photo-1512820790803-83ca734da794?auto=format&fit=crop&q=80&w=400'),
      ('Cien años de soledad', 'Gabriel García Márquez', 'PENGUIN', 'Edición conmemorativa', 450.00, 'La saga de la familia Buendía en el mítico pueblo de Macondo. Obra cumbre del realismo mágico latinoamericano.', 'Físico', 'Activo', '9780307474728', 'https://covers.openlibrary.org/b/isbn/9780307474728-L.jpg'),
      ('Introducción al Cálculo y al Análisis Matemático Vol. 1', 'Richard Courant', 'LIMUSA', '2a edición', 620.00, 'Texto clásico universitario que aborda los fundamentos del cálculo diferencial e integral con rigor matemático.', 'Físico', 'Activo', '9789681800529', 'https://covers.openlibrary.org/b/isbn/9789681800529-L.jpg'),
      ('Psicología del Desarrollo', 'Diane E. Papalia', 'MCGRAW', '12a edición', 780.00, 'Recorre el desarrollo humano desde la concepción hasta la vejez, integrando teoría e investigación.', 'Físico', 'Activo', '9786071509185', 'https://images.unsplash.com/photo-1550184658-ff6132a71714?auto=format&fit=crop&q=80&w=400'),
      ('Administración', 'Stephen P. Robbins', 'PEARSON', '14a edición', 890.00, 'Texto líder mundial en administración que integra conceptos, teoría y práctica gerencial.', 'Físico', 'Activo', '9786073239011', 'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&q=80&w=400'),
      ('Química: La Ciencia Central', 'Theodore L. Brown', 'PEARSON', '14a edición', 950.00, 'Ofrece una presentación clara y precisa de los fundamentos de la química general.', 'Físico', 'Activo', '9780134414232', 'https://covers.openlibrary.org/b/isbn/9780134414232-L.jpg'),
      ('Derecho Civil: Parte General', 'Marcel Planiol', 'CAJICA', '3a edición', 540.00, 'Exposición sistemática de los principios generales del derecho civil: personas, familia, bienes y obligaciones.', 'Físico', 'Activo', '9789685374019', 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fit=crop&q=80&w=400'),
      ('Fundamentos de Programación', 'Luis Joyanes Aguilar', 'MCGRAW', '4a edición', 580.00, 'Introduce la lógica de programación y los algoritmos con un enfoque didáctico y progresivo.', 'Físico', 'Activo', '9788448140977', 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&q=80&w=400'),
      ('Historia Universal Contemporánea', 'Héctor Strobel Ruiz', 'SANTILLANA', '2a edición', 395.00, 'Análisis de los grandes procesos históricos del siglo XX y XXI.', 'Físico', 'Activo', '9786071714527', 'https://covers.openlibrary.org/b/isbn/9786071714527-L.jpg'),
      ('Principios de Economía', 'N. Gregory Mankiw', 'CENGAGE', '8a edición', 860.00, 'El texto de economía más adoptado en universidades de todo el mundo. Explica los principios micro y macroeconómicos.', 'Físico', 'Activo', '9781305971493', 'https://covers.openlibrary.org/b/isbn/9781305971493-L.jpg');
